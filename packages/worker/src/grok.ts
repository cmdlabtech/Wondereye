...
No markdown, no bullet points, !! no character counts in any way !!. Return ONLY a JSON array of objects with "name" and "snippet" fields. The "name" must exactly match the candidate name.
